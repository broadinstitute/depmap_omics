    ...
    if 'gs://' == prev[:5]:
      if new == prev:
        ...
        if code == 0:
          ...
          samp.loc[k, baicol] = new.replace('.bam', '.bai') if os.system('gsutil ls ' + new.replace('.bam', '.bai')) == 0 else new.replace('.bam', '.bam.bai')
        elif code == 256:
          print('not found')
          bai = new.replace('.bam', '.bai') if os.system('gsutil ls ' + new.replace('.bam', '.bai')) == 0 else new.replace('.bam', '.bam.bai')
