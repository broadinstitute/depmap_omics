...
SUBSET_VCF_GCS_PATH = "gs://depmapomics-testdata/inputs/230620/CDS-9ImTq5.filtered.vcf.gz"
VCS_TO_DEPMAP_EXPECTED_GCS_PATH = (
    "gs://depmapomics-testdata/outputs/230620/test_echtvar_cosmic/expected"
)
...
def test_echtvar_cosmic_depmap(tmpdir):
    run_wdl(
        ...
        {"input_vcf": SUBSET_VCF_GCS_PATH, "sample_id": "CDS-9ImTq5"},
        "test_echtvar_cosmic/latest",
    )
