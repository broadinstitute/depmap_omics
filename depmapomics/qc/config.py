...
# FILE_ATTRIBUTES = {
#     'CCLE_expression': {'ismatrix': True, 'hasNA': False, 'gene_id': 'entrez'},
#      'CCLE_expression_proteincoding_genes_expected_count': {'ismatrix': True,
#       'hasNA': False,
#       'gene_id': 'entrez'},
#      'CCLE_mutations_bool_damaging': {'ismatrix': True,
#       'hasNA': False,
#       'gene_id': 'entrez'},
#      'CCLE_mutations_bool_hotspot': {'ismatrix': True,
#       'hasNA': False,
#       'gene_id': 'entrez'},
#      'CCLE_mutations_bool_othercons': {'ismatrix': True,
#       'hasNA': False,
#       'gene_id': 'entrez'},
#      'CCLE_mutations_bool_othernoncons': {'ismatrix': True,
#       'hasNA': False,
#       'gene_id': 'entrez'},
#      'CCLE_RNAseq_transcripts': {'ismatrix': True,
#       'hasNA': False,
#       'gene_id': 'enst'},
#      'CCLE_expression_transcripts_expected_count': {'ismatrix': True,
#       'hasNA': False,
#       'gene_id': 'enst'},
#      'CCLE_expression_full': {'ismatrix': True, 'hasNA': False, 'gene_id': 'ensg'},
#      'CCLE_RNAseq_reads': {'ismatrix': True, 'hasNA': False, 'gene_id': 'ensg'},
#      'CCLE_gene_cn': {'ismatrix': True, 'hasNA': True, 'gene_id': 'entrez'},
#      'CCLE_fusions': {'ismatrix': False},
#      'CCLE_fusions_unfiltered': {'ismatrix': False},
#      'CCLE_segment_cn': {'ismatrix': False},
#      'CCLE_mutations': {'ismatrix': False}}
