...
# generated by mapping hugo symbols in depmapomics/tasks/oncokb_dm/data/oncogene_oncokb.txt to ENSG ids
# using: hgnc_complete_set = tc.get(name='hgnc-gene-table-e250', version=3, file='hgnc_complete_set')
ONCOKB_ONCOGENE_ENSG_LIST = "depmapomics/tasks/oncokb_dm/data/oncogene_oncokb_ensg.txt"
