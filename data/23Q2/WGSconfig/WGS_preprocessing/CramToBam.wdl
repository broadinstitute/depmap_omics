...
import "https://api.firecloud.org/ga4gh/v1/tools/gatk_sv_DQ:Structs.wdl/versions/1/plain-WDL/descriptor"
...
task RunCramToBam {
  ...
  Int vm_disk_size = ceil(disk_overhead + cram_size + bam_size + ref_index_size)
