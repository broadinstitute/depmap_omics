...
# 23Q2
OmicsSomaticMutationsMatrixDamaging <- read.csv('/Users/golden/Documents/repos/depmap_omics/data/tcga_24Q3/output/tcga/merged_somatic_mutations_genotyped_damaging_profile.csv') #load.from.taiga(data.name='internal-23q2-1e49', data.version=98, data.file='OmicsSomaticMutationsMatrixDamaging')

# 23Q2
OmicsSomaticMutationsMatrixHotspot <- read.csv('/Users/golden/Documents/repos/depmap_omics/data/tcga_24Q3/output/tcga/merged_somatic_mutations_genotyped_hotspot_profile.csv') #load.from.taiga(data.name='internal-23q2-1e49', data.version=98, data.file='OmicsSomaticMutationsMatrixHotspot')


test_23Q4_ccle_maf = read.maf("/Users/golden/Documents/repos/depmap_omics/data/tcga_24Q3/output/tcga/merged_somatic_mutations_all_cols_profile.tsv")
...
```{r echo=FALSE, message=FALSE, results='hide'}
AML_maf = read.maf("/Users/golden/Documents/data/omics/tcga_data/tcga_somatic_mafs/23Q4_somatic_mutations_profile_drafted_AML_final.maf")
#LUSC_maf = read.maf("~/mutation/23Q4_somatic_mutations_profile_drafted_LUSC_final.maf")
LUAD_maf = read.maf("/Users/golden/Documents/data/omics/tcga_data/tcga_somatic_mafs/23Q4_somatic_mutations_profile_drafted_LUAD_final.maf")
LUAD_TCGA = tcgaLoad(study = "LUAD") #read.maf("/Users/qqin/Downloads/luad_tcga_pub/data_mutations.txt")
#ESCA_maf = read.maf("~/mutation/23Q4_somatic_mutations_profile_drafted_ESCA_final.maf")
SKCM_maf = read.maf("/Users/golden/Documents/data/omics/tcga_data/tcga_somatic_mafs/23Q4_somatic_mutations_profile_drafted_SKCM_final.maf")
SKCM_TCGA = tcgaLoad(study = "SKCM") #read.maf("/Users/qqin/Downloads/skcm_tcga_pan_can_atlas_2018/data_mutations.txt")
...
```{r}
mike_biomarkers = read.csv("/Users/golden/Documents/data/omics/tcga_data/tcga_somatic_mafs/bench_corrs_for_mike_new (1).csv")
mike_biomarkers_mutation = subset(mike_biomarkers, feat_type!='CN' & feat_type!='GE')
```

```{r echo=FALSE, message=FALSE, results='hide'}
CRISPRGeneEffect <- load.from.taiga('internal-23q2-1e49.100/CRISPRGeneEffect') #read.table("~/Downloads/internal-23q2_v98-crisprgeneeffect.tsv", header=T, sep='\t', row.names=1)

metadata = read.csv("/Users/golden/Documents/data/omics/tcga_data/tcga_somatic_mafs/seq_table.csv", header=T)
